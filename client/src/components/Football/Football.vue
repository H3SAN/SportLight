            ...
            <v-flex xs10 offset-md1>
              ...
              <v-card height="auto" style="margin-bottom:20px;">
                <v-layout row>
                 ...
                 <v-card-text>
                     <h2>Person move</h2><p>A file, in the computer world, is a self-contained piece of information available to the operating system and any number of individual programs.
